...
with st.sidebar:
    ...
    try:
        ...
        audit_csv = client.export_market_data_audit("csv")
        audit_markdown = client.export_market_data_audit("markdown")
        import_payload, update_sample_payload, delete_sample_id = render_market_data_panel(
            market_samples,
            market_audit,
            audit_csv,
            audit_markdown,
